...
# ╔═╡ 54c046b6-9779-4389-8ac7-cac7055d3ae3
using MLJ

# ╔═╡ 53400f5d-e6c5-46f4-b304-5a8b84406ffd
using DataFrames

# ╔═╡ fda731e1-db24-4520-980b-68764106a1aa
using BetaML

# ╔═╡ cfe7bb0e-9076-4952-b6ed-bf01038b8c86
using Plots

# ╔═╡ dbce895a-f99a-11ef-2c01-87d8b771fa7c
md"""
Libro de notas y traducción de [página web](https://forem.julialang.org/mlj/julia-boards-the-titanic-1ne8).
"""

# ╔═╡ 9dfedecf-55eb-48f0-9559-8c7e9a38cbfb
md"""
Importamos las bibliotecas. Pluto gestiona los paquetes de manera transparente, no hace falta utilizar Pkg.
"""

# ╔═╡ b3e2de3d-fd24-4723-87cc-f377e0fd9212
md"""
Cargamos los datos desde OpenML:
"""

# ╔═╡ e2c15323-222f-4f20-bd2d-36bb7187996c
tabla = OpenML.load(42638)

# ╔═╡ a49ee65e-a045-4faf-8634-488f062366e1
md"""
Creamos un DataFrame a partir de la tabla:
"""

# ╔═╡ 7269df3a-d22e-4275-b72e-153255537914
df = DataFrame(tabla)

# ╔═╡ 48ea9d0f-0901-4f45-88c8-3070dc36b5e7
md"""
Veamos algunas características estadísticas de los datos:
"""

# ╔═╡ 9ecf3df2-e171-4201-a5f0-f6601e030a02
describe(df)

# ╔═╡ fdbfa3da-338c-4e0f-8cf2-13b63b9e1c77
md"""
Los tipos scitypes:
"""

# ╔═╡ fb13a43d-d4bc-4d87-b8ca-1652d2756f22
schema(df)

# ╔═╡ 80f4501e-c4aa-4f14-8d2b-ec5b8cd4d7ab
md"""
Hacemos un cambio de tipo en **sibsp**:
"""

# ╔═╡ 2ad06fbb-8b77-40bd-a2be-2883d56a0894
coerce!(df, :sibsp => Count)

# ╔═╡ a1faf9ea-fcee-4976-98d3-b1c47fdd107f
md"""
Dividimos el conjunto de datos en datos de entrenamiento (70%) y de prueba (30%), y fijamos el origen de generación de números aleatorios con rng=123:
"""

# ╔═╡ 96547b7d-8d12-4130-a947-cf614b2e5e52
entrenamiento, prueba = MLJ.partition(df, 0.7, rng=123)

# ╔═╡ 0b01f105-6294-417b-8c37-d7402a0f13a5
md"""
Separamos los datos entre predictores y variable a predecir del cojunto de entrenamiento:
"""

# ╔═╡ 6127c6fb-b738-4bda-9f58-e0effa40bde8
yentrenamiento, Xentrenamiento = unpack(entrenamiento, ==(:survived), !=(:cabin))

# ╔═╡ a7184e06-2176-41a8-934f-d662627f7178
md"""
y lo mismo para el conjunto de prueba:
"""

# ╔═╡ 84bed5ec-530d-4b0f-aca9-8e8c3dd2c626
yprueba, Xprueba = unpack(prueba, ==(:survived), !=(:cabin))

# ╔═╡ e97d362e-bcf4-45d8-9d4d-3f3c55d91631
md"""
Preguntamos a MLJ por los modelos que podemos aplicar sobre el conjunto de datos que tenemos:
"""

# ╔═╡ 72634127-fd03-47a2-9296-fea23a97743c
models(matching(Xentrenamiento, yentrenamiento))

# ╔═╡ 54bbce3e-a893-49ce-9b9a-24f3534aa5bd
md"""
De entre los modelos disponibles vamos a utilizar DecisionTreeClassifier:
"""

# ╔═╡ 1621a7d4-8a33-4ff5-8f15-58d5fa614448
Arbol = @load DecisionTreeClassifier pkg=BetaML

# ╔═╡ 41fab2d2-7f0b-4295-888c-5ca35be0a12b
md"""
Creamos una instancia del modelo.
"""

# ╔═╡ c60d7b8c-fc8d-45a1-a7dc-ffbec689d896
arbol = Arbol(max_depth=10)

# ╔═╡ 2b923ab1-521d-47c3-9cc9-dca691292005
md"""
Ahora construimos un máquina para entrenar el modelo:
"""

# ╔═╡ 39d82a2a-f11b-485d-84bf-283a9f148349
maquina = machine(arbol, Xentrenamiento, yentrenamiento)

# ╔═╡ 8afe3eb3-70c4-4f93-b551-0f0c46810a56
md"""
y realizamos el entrenamiento:
"""

# ╔═╡ d53c628f-ef93-4c84-aa37-678d9c2d2b39
MLJ.fit!(maquina)

# ╔═╡ 350363dd-a2ef-493a-9f07-e90ad50957a3
md"""
Veamos qué tal funciona sobre el propio conjunto de datos de entrenamiento:
"""

# ╔═╡ 9f9405f4-dbbb-4ffe-84f5-836e2c24bd28
predicciones_entrenamiento = MLJ.predict(maquina, Xentrenamiento)

# ╔═╡ 2be108a9-49e4-4af8-a0da-d44f34ddc549
md"""
La predicción para el primer elemento del conjunto:
"""

# ╔═╡ 862d3892-ae56-4ba8-b2f3-34f1812f92e9
predicciones_entrenamiento[6]

# ╔═╡ 9d9a69f2-8fcf-4762-8f03-6e37c8b59d8b
md"""
que también se puede obtener de este modo:
"""

# ╔═╡ c6f62f03-2c16-4d81-9da6-1fbe9903806b
pdf(predicciones_entrenamiento[6], "1")

# ╔═╡ 3dde5f27-c556-4c6c-80ba-49c24dd99526
md"""
Las predicciones para los datos de entrenamiento:
"""

# ╔═╡ 96f5d621-1d58-4de5-b1f2-c3d89ad41eb5
ypredicciones = MLJ.mode.(predicciones_entrenamiento)

# ╔═╡ 65795f4b-02a6-47fe-a449-25c4a50b4db5
md"""
La precisión del modelo sobre los datos de entrenamiento:
"""

# ╔═╡ 97ee2a38-9f65-4570-baaa-0be78edcfe2f
MLJ.accuracy(ypredicciones, yentrenamiento)

# ╔═╡ acbdf77d-b154-4d66-a762-fcc1e139714b
md"""
La predicción del modelo sobre los datos de prueba:
"""

# ╔═╡ 8ef96bfb-5b89-4757-92c1-2cc2a19986c6
predicciones_prueba = MLJ.predict(maquina, Xprueba)

# ╔═╡ 3d0ffa18-1a97-450f-b671-d9a7709b4471
ypredicciones_prueba = MLJ.mode.(predicciones_prueba)

# ╔═╡ e33a6536-ab0c-4ac4-a4cd-76b5d66a92cd
md"""
La precisión sobre los datos de prueba:
"""

# ╔═╡ 246f5d68-8b40-42a8-8991-89d26f4a44c4
MLJ.accuracy(yprueba, ypredicciones_prueba)

# ╔═╡ 793bff0a-6c1a-44f9-a0ba-82798c8e5773
md"""
Quizás haya algo de overfitting, vamos a intentar minimizarlo. Vamos a intentar determinar una buena profundidad para el árbol (lower=0 significa sin límite):
"""

# ╔═╡ 25fd92e4-5df8-4f65-8f9b-e65179928b33
profundidad = range(arbol, :max_depth, lower=0, upper=12)

# ╔═╡ fd909c4f-0695-4121-ae64-7a7b821f2f22
arbol_ajustado = TunedModel(
	arbol,
	tuning = Grid(),
	range = profundidad,
...
# ╔═╡ 3bf9b15f-735f-4739-89b5-0bc12df23659
md"""
Definimos una nueva máquina para ajustar la profundidad del árbol:
"""

# ╔═╡ a1031d79-7710-4f6d-bc78-2eb1f741985f
maquina_ajuste = machine(arbol_ajustado, Xentrenamiento, yentrenamiento)

# ╔═╡ aa8c1946-60c2-418e-a5f3-e45e03eb3e85
md"""
Entrenamos la nueva máquina:
"""

# ╔═╡ c1c67b9e-c8c0-42f1-9222-cc2aa613c190
MLJ.fit!(maquina_ajuste)

# ╔═╡ 1e292b7b-20ac-4743-b87b-574dcb6a6750
md"""
Veamos cuál ha sido el mejor modelo que ha encontrado:
"""

# ╔═╡ 759860fe-c36c-4855-b22c-5cd0e419294c
fitted_params(maquina_ajuste).best_model

# ╔═╡ 1d2bd571-d593-417e-85ed-be7ddf02b0c8
md"""
Hagamos las predicciones con el nuevo modelo:
"""

# ╔═╡ 765ce504-9447-4fbe-b289-7a69e8c8f98a
ypredicciones_prueba_arbol_ajustado = MLJ.mode.(MLJ.predict(maquina_ajuste, Xprueba))

# ╔═╡ a5c3e18f-1d20-405d-8a6a-87df908e6b64
md"""
Calculemos la precisión para el mejor modelo encontrado.
"""

# ╔═╡ c6248443-05d8-43f5-b599-bf0538e6b95c
MLJ.accuracy(yprueba, ypredicciones_prueba_arbol_ajustado)

# ╔═╡ aece1aed-947a-4bf9-899f-0460e87bc9d0
md"""
Voy a ver si puedo dibujar la curva roc:
"""

# ╔═╡ ae4432e1-b5fc-4f42-b316-88d88f21e38c
MLJ.confmat(yprueba, ypredicciones_prueba_arbol_ajustado)

# ╔═╡ 4feea444-943a-446c-be4b-7909d300bd13
roc = MLJ.roc_curve(MLJ.predict(maquina_ajuste, Xprueba), yprueba)
# roc = MLJ.roc_curve(MLJ.predict(maquina, Xentrenamiento), yentrenamiento)

# ╔═╡ f07e7666-8c80-47a3-972a-e65bf72310d8
function graficoroc()
	plot(roc)
	plot!([0,1], [0,1], color=:black)
end

# ╔═╡ a2e0022d-003f-45c6-9926-aef7a46d61d1
graficoroc()
...
manifest_format = "2.0"
project_hash = "bede959399013f98636b8a6e5cf6b226c9525ee7"
...
git-tree-sha1 = "dfcab2c043b169999f662fe02abf0544642c68d7"
