...
#> 
#>     [[frontmatter.author]]
#>     name = "Óscar Belmonte Fernández"
#>     url = "https://www3.uji.es/~belfern"
...
# ╔═╡ 6e640278-d33c-4920-baeb-d7fad757a6b5
Resource(
...
- Resumir en qué consiste el Aprendizaje Automático.
- Razonar si un determinado problema de AA es supervisado, no-supermisado, semi-supervisado o por refuerzo.
- Razonar si un determinado problema implica regresión o clasificación.
- Resumir en qué consiste la generalización.
- Interpretar si un modelo está subestimado o sobrestimando los datos de entrenamiento.
...
Otra métrica bastante informativa en clasificación binaria es el Área Bajo la Curva (AUC - Area Under the Curve).
"""
