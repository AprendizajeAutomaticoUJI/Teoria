...
# ╔═╡ 9c127ea5-9eae-45bf-9e65-be853a828c02
using Distributions

# ╔═╡ beb1c55e-59a4-4891-a09b-a073090cdfb3
using StatsPlots

# ╔═╡ 075d08ed-abd6-429d-b8a1-feb7f9003fdb
using PlutoUI

# ╔═╡ b7d4b3e0-0bf3-4749-be76-af4a0197255a
...
# ╔═╡ 950e45b0-1653-46ad-a1b0-9559034847a0
...
Segunda hipótesis, $\epsilon$ es un error que sigue una distribución normal con media $0$ y varianza $\sigma^2$, que se representa como: $\epsilon \sim N(0, \sigma^2)$ y es la misma distribución para cualquier punto de la recta (criterio de **homocedasticidad**).
"""
...
El objetivo es encontrar los parámetros $\theta$ que minimizan la distancia euclidea entre los datos reales $y_i$ y los valores calculados $\hat y_i = h_\theta(x_i)$. Luego *menor distancia* significa *menor distancia euclidea*.
...
y que esta distribución es la misma con independencia del punto de la recta en la que nos encontremos (homocedasticidad).
...
let
	hline([0, 300], [0, 0], color = :red, width = 2)
	scatter!(residuos, title="Residuos", legend=false, xlabel="muestra", ylabel="residuos", size=(900,400), color =:lightblue)
end
...
md"""
La prueba de Shapiro-Wilk nos dice que no podemos rechazar la hipótesis nula (en este caso que los datos siguen una distribución normal) si el p-valor en mayor que 0.05. En nuestro caso, el p-valor que obtenemos es $(pvalue(ShapiroWilkTest(residuos)))
"""
...
# ╔═╡ ba57a122-ae76-4433-a57e-3a19af282dab
md"""
## Paquetes en Julia
...
sumatorio que depende de $\theta$, que es proporcional a la función de pérdidas, luego **minimizar las distancias eclideas es lo mismo que minimizar la función de pérdidas**
...
# ╔═╡ 96d44986-6bca-4651-86b2-4bd84b31410c
md"""
## Normalidad de los residuos
"""
...
md"""
La prueba de normalidad ahora pasa.
"""

# ╔═╡ 79d161c6-f57d-4baf-a8a7-90535d1fe3de
md"""
## Normalidad de los residuos

Y el gráfico cuantil-cuantil ha mejorado
"""
