...
potencias = repeat(X, 1, maximo_grado) .^ (1:maximo_grado)';
...
# ╔═╡ b4aa21fa-6268-4d71-9674-ea401c38fbc9
md"""
Preparo los datos para hacer la predicción.
"""

# ╔═╡ 12d97d81-6cad-4e6c-a42e-acfba51b27fd
intervalo = range(minimum(X), maximum(X), 100)

# ╔═╡ 0c69a61c-4667-404b-8906-ccc1e24c2ef1
potencias_prediccion = repeat(intervalo, 1, maximo_grado) .^ (1:maximo_grado)';

# ╔═╡ f61b6ce6-9fd8-4680-9734-b07f2b79be5c
prediccion = potencias_prediccion * A .+ b;

# ╔═╡ 7f99bc42-9739-405f-9166-0ae1863f40f5
md"""
...
begin
	scatter(X, y, ylim=(140,220), legend=false)
...
resultado = MLJLinearModels.fit(LassoRegression(0.7), potencias, y)
...
manifest_format = "2.0"
project_hash = "2a133e9a621a7ab91179a3a18acc45bcb444dc8a"
